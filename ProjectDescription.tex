...
\skillnum{TwoCPU} & Run numerical programs that take advantage of multiple cores and/or a GPU on a single machine &
...
UG & HS & \ref{Camp}\tabularnewline
\skillnum{ContLib} & Contribute to a well-documented numerical software library consisting of documented, tested, robust routines & & G & \ref{RelSoft} \tabularnewline
