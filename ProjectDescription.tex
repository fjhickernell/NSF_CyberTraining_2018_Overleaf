...
\subsubsection{Intellectual Merit} This collaborative project (total budget \$842,298.00, shared with Prof. W. Gropp of U Illinois and Prof.~Y.~Chen of UTT) developed a decoupled execution paradigm (DEP) to address I/O bottleneck issues. This paradigm enables users to identify and handle data-intensive operations separately. Broader Impacts: Technical hurdles have been identified for decoupled execution, spanning system architecture, programming model, and runtime system. Results are available as recent publications \cite{KYES16}, ZLKR16, HeWS16, HeWS16a, HWSX17, HWLS17, HWSH17, SuWa14, WaSu14] and other I/O related publications. In addition, in the past five years, Dr. Sun has graduated 3 PhD and 11 masters students and supervised 5 postdoctoral and 4 graduate researchers.
[KYES16]	A. Kougkas, Y. Yin, H. Eslami, X. Sun, Y. Chen, and R. Thakur, "Rethinking Key-Value Store for Parallel I / O Optimization," Int. J. High Perform. Comput. Appl., 2016.
[HeWS16]	S. He, Y. Wang, and X.-H. Sun, "Boosting Parallel File System Performance with Heterogeneity-Aware Selective Data Layout," IEEE Transactions on Parallel and Distributed Systems (TPDS), vol. 27, no. 9, pp. 2492-2505, Sept. 2016. 
[HeWS16a]	S. He, Y. Wang, and X.-H. Sun, "Improving Performance of Parallel I/O Systems through Selective and Layout-Aware SSD Cache," IEEE Transactions on Parallel and Distributed Systems (TPDS), vol. 27, no. 10, pp. 2940-2952. 2016.
[HWLS17]	S. He, Y. Wang, Z. Li, X.-H. Sun, and C. Xu, "Cost-Aware Region-Level Data Placement in Multi-Tiered Parallel I/O Systems," IEEE Transactions on Parallel and Distributed Systems (TPDS), vol. 28, no. 7, pp. 1853-1865, June. 2017.
[HWSH17]	S. He, Y. Wang, X.-H. Sun, C. Huang, and C. Xu, "Heterogeneity-Aware Collective I/O for Parallel I/O Systems with Hybrid HDD/SSD Servers," IEEE Transactions on Computers (TC), vol. 66, no. 6, pp. 1091-1098, June. 2017.
[HWSX17]	S. He, Y. Wang, X.-H. Sun, and C. Xu, "HARL: Optimizing Parallel File Systems with Heterogeneity-Aware Region-Level Data Layout," IEEE Transactions on Computers (TC), vol. 66, no. 6, pp. 1048-1060, June. 2017.
[SuWa14]	X.-H. Sun and D. Wang, "Concurrent Average Memory Access Time," IEEE Computer, vol. 47, no. 5, pp. 74-80, May 2014
[WaSu14] 	D.Wang and X.H. Sun, "APC: A Novel Memory Metric and Measurement Methodology for Modern Memory System", IEEE Transactions on Computers, vol. 63, no. 7, pp. 1626-1639, July. 2014..
[ZLKR16]	D. Zhao, N. Liu, D. Kimpe, R. Ross, X.-H. Sun, and I. Raicu, "Towards Exploring Data-Intensive Scientific Applications at Extreme Scales through Systems and Simulations," IEEE Transactions on Parallel and Distributed Systems (TPDS), vol. 27, no. 6, pp. 1824-1837, June 2016.
