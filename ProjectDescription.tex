...
In addition to GAIL, Choi is a seasoned, multi-lingual industrial software engineer/data scientist, as well as a co-creator of multiple robust, large-scale scientific algorithms and software packages with accompanied publications~\cite{CLM17,C14b,C14a,CS14,CPS11,DFHL03}. She was a co-winner of the SIAM Linear Algebra Prize 2012. She is an advocate of reproducible computational research through better sustainable software engineering practices~\cite{KCNN16,KCWH16,KCLM14,C14a} and scientific software citations~\cite{SKNF11}. She has mentored high school through post-doctoral researchers in appliedcomputational sciences. 
